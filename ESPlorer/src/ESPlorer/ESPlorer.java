...
"     if buf ~= nil then\n" +
"     local n \n" +
"     if #buf < 16 then n =#buf else n=math.ceil(#buf/16) * 16 end\n" +
"     for i=1, n do\n" +
"         if (i-1) % 16 == 0 then\n" +
"               uart.write(0,string.format('%08X  ', i-1)) \n" +
"         end\n" +
...
//                btnSend("file.close();");
                ...
                log        ( "Waiting answer from ESP - Timeout reached. Send aborted.");
            }
        };
